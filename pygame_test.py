...
if __name__ == "__main__":
    ...
    eat_pizza_sound = pygame.mixer.Sound('/home/gabi/Desktop/game/eat_pizza.wav')
    eat_tuna_sound = pygame.mixer.Sound('/home/gabi/Desktop/game/eat_tuna.wav')
    pizza_img = pygame.image.load("/home/gabi/Desktop/game/pizza.png")
    level_img = pygame.image.load("/home/gabi/Desktop/game/level.png")
    ...
    level_ctr_img = level_img.get_rect(top=0, left=screen_width-200)
    ...
    while True:
        ...
        screen.blit(level_img, level_ctr_img)
